...
* The use of sexually explicit language or imagery, and sexual attention or
...
This Code of Conduct is adapted from the {url-cchomepage}[Contributor Covenant]
version 2.0, available at {url-ccv2}.
